...
public class AuthenticationFilter implements Filter {
	...
	// Static resources
	private static final String[] PUBLIC_RESOURCES = { ".css", ".js", ".png", ".jpg", ".jpeg", ".gif", ".ico", ".woff",
			".woff2", ".ttf", ".svg", ".mp4" };
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if ("admin".equals(userRole)) {
			...
			if (uri.equals(LOGIN) || uri.equals(REGISTER) || uri.equals(ROOT)) {
	...
	private boolean isCustomerAllowedPage(String uri) {
		return uri.equals(HOME) || uri.equals(RESULT) || uri.equals(PROFILE) || uri.equals(PROPERTY)
				|| uri.equals(ABOUT) ||  uri.equals(PAYMENT) || uri.equals(BOOKING) || uri.equals(REVIEW) || uri.equals(PROPERTY_DESCRIPTION)
				|| uri.equals(filterProperties) || uri.equals(PROFILE_IMAGE) || uri.equals(WishList)
				|| uri.equals(VIEW_BOOKINGS) || uri.equals(LOGOUT);
	}

	private boolean isAdminAllowedPage(String uri) {
		return uri.equals(DASHBOARD) || uri.equals(PROFILE_IMAGE) || uri.equals(PROPERTY_DASHBOARD)
				|| uri.equals(USER_DETAILS) || uri.equals(USER_DASHBOARD) || uri.equals(ADD_PROPERTY)
				|| uri.equals(BOOKING_DASHBOARD) || uri.equals(USER_PROFILE) || uri.equals(ADD_IMAGES)
				|| uri.equals(ADD_PROPERTY_AMENITIES) || uri.equals(ADD_PROPERTY_SUCESS) || uri.equals(DASHBOARD_SEARCH)
				|| uri.equals(UPDATE_PROPERTY) || uri.equals(LOGOUT);
