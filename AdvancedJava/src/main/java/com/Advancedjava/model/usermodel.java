...
public class usermodel {
	...
	public usermodel(String userId, String userFirstName, String userLastName, String userEmail, String userName,
			String userDob, String userPhnNo, com.Advancedjava.model.usermodel.gender gender, String userPassword,
			String userRole, String userProfilePicture, com.Advancedjava.model.usermodel.userStatus userStatus) {
	...
	public usermodel(String userFirstName, String userLastName, String userEmail, String userName, String userDob,
			String userPhnNo, String userPassword) {
		this.userFirstName = userFirstName;
		this.userLastName = userLastName;
		this.userEmail = userEmail;
		this.userName = userName;
	...
	public usermodel(String userFirstName, String userLastName, String userEmail, String userName, String userDob,
			String userPhnNo, String userPassword, String userRole) {
		this.userFirstName = userFirstName;
		this.userLastName = userLastName;
		this.userEmail = userEmail;
		this.userName = userName;
