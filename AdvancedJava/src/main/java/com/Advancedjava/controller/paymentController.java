...
public class paymentController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			long dayDiff = (booking.getCheckInDate().getTime() - booking.getCheckInDate().getTime())
					/ (1000 * 60 * 60 * 24);
			...
			request.setAttribute("tax",
					booking.getTotalPrice()
							.subtract(booking.getBasePrice().multiply(BigDecimal.valueOf(dayDiff))
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			PaymentModel payment = new PaymentModel(booking.getTotalPrice(), paymentMethod, paymentStatus,
					new Date(System.currentTimeMillis()), bookingId);
	...
	private boolean isValidPaymentMethod(String paymentMethod) {
		return paymentMethod.equals("card") || paymentMethod.equals("bank") || paymentMethod.equals("wallet")
