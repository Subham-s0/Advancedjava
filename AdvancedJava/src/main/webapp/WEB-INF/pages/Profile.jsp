 ...
 <div class="main-container">
        ...
        <div class="content-area">
                 ...
                 <input type="hidden" name="formType" value="profileUpdate" />
                    <div class="form-row">
                        ...
                        <label for="firstName">First Name</label>
                            <input type="text" id="firstName" name="firstName" value="${Current_user.userFirstName}" >
                            
                        </div>
                        <div class="form-group">
                         <label for="lastName">Last Name</label>
                           <input type="text" id="lastName" name="lastName" value="${Current_user.userLastName}" >
                       ...
                       <div class="form-group">
						    ...
						    <div class="radio-group" >
						        <label class="radio-label">
						            <input type="radio" id="gender-male" name="gender" value="male" <c:if test="${Current_user.gender == 'male'}">checked</c:if> >
						            <span>Male</span>
						        </label>
						        <label class="radio-label">
						            <input type="radio" id="gender-female" name="gender" value="female" <c:if test="${Current_user.gender == 'female'}">checked</c:if>>
						            <span>Female</span>
						        </label>
						    </div>
						</div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="date" id="dob" name="dob" value="${Current_user.userDob}" >
                        </div>
                        <div class="form-group">
                            <label for="email">Email Address</label>
                            <input type="email" id="email" name="email" value="${Current_user.userEmail}" >
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="tel" id="phone" name="phone" value="${Current_user.userPhnNo}" >
            ...
            <section id="change-password" class="content-section ">
                ...
                <div class="error-message <%= (errorPassword != null && !errorPassword.isEmpty()) ? "visible" : "" %>">
					   <c:if test="${not empty errorPassword}">
			        <p style="color: red;"><c:out value="${errorPassword}"/></p>
			    </c:if>
...
<c:set var="openSection" value="${openSection != null ? openSection : ''}" />
